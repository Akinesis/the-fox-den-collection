...
import cutefox.foxden.item.renderer.SteelArmorRenderer;
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<>(this, 20, state -> {
            ...
            boolean isFullSet = wornArmor.containsAll(ObjectArrayList.of(
                    Registries.ITEM.getEntry(ModItems.STEEL_BOOTS),
                    Registries.ITEM.getEntry(ModItems.STEEL_LEGGINGS),
                    Registries.ITEM.getEntry(ModItems.STEEL_CHESTPLATE),
                    Registries.ITEM.getEntry(ModItems.STEEL_HELMET)));

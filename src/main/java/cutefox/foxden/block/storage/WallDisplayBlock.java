...
public class WallDisplayBlock extends StorageBlock {
   public static final MapCodec<WallDisplayBlock> CODEC = createCodec(WallDisplayBlock::new);
   ...
   public WallDisplayBlock(Settings settings) {
      super(settings);
   ...
   public boolean canInsertStack(ItemStack stack) {
      return stack.isIn(ModItemTags.BREAD);
   }
   ...
   static {
      ...
      voxelShapeSupplier = () -> {
         ...
         shape = VoxelShapes.combine(shape, VoxelShapes.cuboid(0.0D, 0.0D, 0.5D, 1.0D, 1.0D, 1.0D), BooleanBiFunction.OR);
         return shape;
      };
